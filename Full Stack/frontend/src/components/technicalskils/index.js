...
const TechnicalSkillsForm = () => {
    ...
    try {
      ...
      if (status === 201 || status === 200) {
        setSubmissionMessage(
          status === 201 ? 'Successfully submitted the technical skill form!' : 'Successfully updated the technical skill form!'
        );
  ...
  return (
    <div className="container mt-5">
      <h2 className="mb-4">Technical Skills Assessment</h2>
